  ...
  return (
    <div ref={ref} className={cx(styles.container)}>
      <div className={cx(styles.inner)}>
        <div className={cx('quote-sm', styles.quote)}>
          <motion.span
            variants={variants}
            initial="hidden"
        ...
        <div className={styles.attribution}>
          {attribution?.name && (
            <div className={cx('press-quote-attribution', styles.name)}>
              {attribution.name}
            </div>
          )}
          {attribution?.title && (
            <div className={cx('press-quote-source', styles.name)}>
              {attribution.title}
              {attribution?.source && (
                <span className={cx('press-quote-source', styles.source)}>
                  {`, `}
